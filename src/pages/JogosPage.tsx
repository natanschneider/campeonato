...
export default function JogosPage({ data }: { data: MatchesResponse }) {
	...
	return (
		<div className="min-h-screen p-4 md:p-8">
			<div className="max-w-6xl mx-auto">
				<div className="mb-8">
					<h1 className="text-3xl md:text-4xl font-bold mb-2">Jogos</h1>
				...
				<div className="space-y-4">
					{data.jogos.map((match, index) => {
						const status = getStatusBadge(match.placar1, match.placar2);
									...
									<div className="flex items-center justify-between gap-6">
										<div className="flex items-center gap-3 flex-1">
											<Avatar className="h-12 w-12">
												<AvatarImage src={match.Brasao1} alt={match.Time1} />
												<AvatarFallback>
										...
										<div className="flex items-center gap-3 flex-1 justify-end">
											<p className="text-3xl font-bold">{match.placar2}</p>
											...
											<Avatar className="h-12 w-12">
												<AvatarImage src={match.Brasao2} alt={match.Time2} />
												<AvatarFallback>
